...
<template>
  <div class="arena-container min-h-screen flex relative overflow-hidden">
    ...
    <div
      ...
      class="side-panel hidden lg:flex flex-1 flex-col gap-4 p-4 min-w-[200px] relative z-10"
    >
      ...
      <div class="quest-grid">
        <SideQuestCard
          v-for="rock in leftSideRocks"
          :key="rock.id"
          :rock="rock"
          :is-locked="!canAccessSideQuests"
          :is-active="activeRockId === rock.id"
          @select="handleSwitchRock"
        />
        <button
    ...
    <Transition name="fade">
      <CreateSideQuestModal
        v-if="showCreateModal"
        @close="showCreateModal = false"
        @create="handleCreateSideQuest"
      />
    </Transition>
  </div>
</template>
